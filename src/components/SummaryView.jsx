                  ...
                  <BarChart data={graphData} layout="vertical" margin={{ top: 5, right: 30, left: 40, bottom: 5 }}>
                    ...
                    <Bar dataKey="ยอดใช้จ่าย" radius={[0, 4, 4, 0]} barSize={20}>
                      {graphData.map((entry, index) => {
                        return <Cell key={`cell-${index}`} fill={getColorForItem(entry.rawName)} />;
                      })}
                    </Bar>
                  </BarChart>
                </ResponsiveContainer>
                  ...
                  <AreaChart data={selectedItem.history} margin={{ top: 10, right: 30, left: 10, bottom: 5 }}>
                    <defs>
                      <linearGradient id="colorPrice2" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="5%" stopColor={getColorForItem(selectedItem.name)} stopOpacity={0.3}/>
                        <stop offset="95%" stopColor={getColorForItem(selectedItem.name)} stopOpacity={0}/>
                      </linearGradient>
                    </defs>
                    ...
                    <Area 
                      ...
                      stroke={getColorForItem(selectedItem.name)} 
                      fillOpacity={1} 
                      fill="url(#colorPrice2)"
                      strokeWidth={3}
                      dot={{ r: 4, fill: getColorForItem(selectedItem.name), strokeWidth: 2, stroke: '#fff' }}
